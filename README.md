...
# 18171-playback-api-paging
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-playback-api-paging.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>playback-paging.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>playback-paging.css</strong>.</td>
    </tr>
  </tbody>
</table>
